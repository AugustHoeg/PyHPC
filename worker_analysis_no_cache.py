...
from project.speed_tests import run_speed_test, plot_time_plots, save_results, plot_time_plots_multi, plot_analysis_num_workers_no_cache
...
if __name__ == "__main__":
    ...
    plot_analysis_num_workers_no_cache(result_dict_list, save_path="figures", filename_prefix=f"worker_analysis_no_cache_patch_size_{patch_size}")
    print("Plotting done")