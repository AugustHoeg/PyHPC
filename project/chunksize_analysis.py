...
from project.speed_tests import run_speed_test, plot_time_plots, save_results
...
if __name__ == "__main__":
    ...
    out_file = f"../results/chunksize_analysis_patch_size_{patch_shape[0]}_{current_time}.txt"
